...
namespace projet1
{
    public class ModelBD : DbContext
    {
        ...
        public class Message
        {
            ...
            [ForeignKey("emetteur"), Column(Order = 1)]
            public int emetteurId { get; set; }
            [ForeignKey("recepteur"), Column(Order = 2)]
            public int? recepteurId { get; set; }
            public virtual recepteur recepteur { get; set; }
            public virtual emetteur emetteur { get; set; }

            // public virtual utilisateur recepteur { get; set; }
